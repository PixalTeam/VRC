...
public class ProcInitializer extends Initializer {
    ...
    public static void emitLoadModuleMethod(LambdaExp proc2, Compilation comp) {
        String initName;
        Symbol sym;
        ...
        if (!(!comp.immediate || pname == null || pdecl == null)) {
            ...
            Object old = env.get(sym, comp.getLanguage().getEnvPropertyFor(proc2.nameDecl), null);
        ...
        code.emitPushInt(((proc2.keywords == null ? proc2.max_args : -1) << 12) | proc2.min_args);
