...
public class srfi1 extends ModuleBody {
    ...
    public static final ModuleMethod f2break;
    ...
    static {
        ...
        f2break = new ModuleMethod(srfi1, 164, Lit80, 8194);
        ...
        lambda$Fn64 = new ModuleMethod(srfi1, 182, null, 8194);
        lambda$Fn78 = new ModuleMethod(srfi1, 183, null, 8194);
        $instance.run();
    }
    ...
    public static LList listCopy(LList lis) {
        ...
        while (lists.isPair(lis)) {
            LList cons = lists.cons(lists.car.apply1(lis), LList.Empty);
            if (prev == LList.Empty) {
                result = cons;
            } else {
                try {
                    lists.setCdr$Ex((Pair) prev, cons);
                } catch (ClassCastException e) {
    ...
    public static Object iota(IntNum count2, Numeric start, Numeric step) {
        ...
        try {
            ...
            r7 = count2;
            while (Scheme.numLEq.apply2(r7, Lit0) == Boolean.FALSE) {
                r7 = AddOp.$Mn.apply2(r7, Lit1);
    ...
    /* JADX WARNING: Incorrect type for immutable var: ssa=gnu.math.IntNum, code=java.lang.Object, for r9v0, types: [gnu.math.IntNum, java.lang.Object] */
    public static Object take(Object lis, Object k) {
        LList lList = LList.Empty;
        while (!numbers.isZero((Number) k)) {
            try {
                Object lis2 = lists.cdr.apply1(lis);
                k = AddOp.$Mn.apply2(k, Lit1);
                lList = lists.cons(lists.car.apply1(lis), lList);
                lis = lis2;
            } catch (ClassCastException e) {
                throw new WrongType(e, "zero?", 1, k);
            }
        }
        try {
    ...
    /* JADX WARNING: Incorrect type for immutable var: ssa=gnu.math.IntNum, code=java.lang.Object, for r6v0, types: [gnu.math.IntNum, java.lang.Object] */
    public static Object drop(Object lis, Object k) {
        while (!numbers.isZero((Number) k)) {
            try {
    ...
    /* JADX WARNING: Incorrect type for immutable var: ssa=gnu.math.IntNum, code=java.lang.Object, for r8v0, types: [gnu.math.IntNum, java.lang.Object] */
    public static Object splitAt(Object x, Object k) {
        LList lList = LList.Empty;
        while (!numbers.isZero((Number) k)) {
            try {
    ...
    /* JADX WARNING: Incorrect type for immutable var: ssa=gnu.lists.Pair, code=java.lang.Object, for r2v0, types: [gnu.lists.Pair, java.lang.Object] */
    public static Object lastPair(Object lis) {
        while (true) {
            Object tail = lists.cdr.apply1(lis);
