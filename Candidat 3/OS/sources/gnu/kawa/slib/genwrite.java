...
public class genwrite extends ModuleBody {
    ...
    public class frame extends ModuleBody {
        ...
        public static Object lambda1isReadMacro(Object l) {
            ...
            Object x = Scheme.isEqv.apply2(head, genwrite.Lit30);
            if (x == Boolean.FALSE) {
                Object x2 = Scheme.isEqv.apply2(head, genwrite.Lit31);
                if (x2 == Boolean.FALSE) {
                    Object x3 = Scheme.isEqv.apply2(head, genwrite.Lit32);
                    return x3 == Boolean.FALSE ? Boolean.FALSE : Boolean.FALSE;
                }
            }
            Object l2 = tail;
    ...
    public class frame0 extends ModuleBody {
        ...
        public Object lambda8ppExpr(Object expr, Object col, Object extra) {
            ...
            Object x2 = Scheme.isEqv.apply2(head, genwrite.Lit2);
            if (x2 == Boolean.FALSE) {
                Object x3 = Scheme.isEqv.apply2(head, genwrite.Lit3);
                if (x3 == Boolean.FALSE) {
                    Object x4 = Scheme.isEqv.apply2(head, genwrite.Lit4);
                    if (x4 == Boolean.FALSE) {
                        x = Scheme.isEqv.apply2(head, genwrite.Lit6);
                        if (x != Boolean.FALSE ? Scheme.isEqv.apply2(head, genwrite.Lit7) != Boolean.FALSE : x != Boolean.FALSE) {
                            proc = this.pp$MnIF;
                            ...
                            if (Scheme.isEqv.apply2(head, genwrite.Lit8) != Boolean.FALSE) {
                                proc = this.pp$MnCOND;
