...
public class ReaderXmlElement extends ReadTableEntry {
  ...
  mth insns count: 211
    ...
    public static Object readElementConstructor(LispReader reader, int ch) throws IOException, SyntaxException {
        ...
        PairWithPosition make = PairWithPosition.make(tag, LList.Empty, reader.getName(), startLine, startColumn);
        ...
        while (true) {
            ...
            if (ch2 < 0 || ch2 == 62 || ch2 == 47) {
                ...
                Pair attrTail2 = readContent(reader, (char) ch3, attrPair);
                if (definingNamespace != null) {
                    ? pairWithPosition2 = new PairWithPosition(attrPair, Pair.make(definingNamespace, attrPair.getCdr()), r182);
                    r18 = pairWithPosition2;
                } else {
                    PairWithPosition make2 = PairWithPosition.make(attrList, reader.makeNil(), null, -1, -1);
                    pairWithPosition.setCdrBackdoor(make2);
        ...
        if (!empty2) {
            ...
            Pair resultTail = readContent(reader, '<', pairWithPosition);
        ...
        return PairWithPosition.make(MakeXmlElement.makeXml, Pair.make(LList.reverseInPlace(r182), make), reader.getName(), startLine, startColumn);
    }
