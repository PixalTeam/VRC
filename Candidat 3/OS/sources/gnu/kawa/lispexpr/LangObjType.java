...
public class LangObjType extends ObjectType implements TypeValue {
    ...
    public int compare(Type other) {
        switch (this.typeCode) {
            case 4:
                if (other == typeType || other == typeClassType || other == typeType.implementationType || other == typeClassType.implementationType) {
                    return -1;
                }
            case 5:
                if (other == typeClass || other == typeClassType || other == typeClass.implementationType || other == typeClassType.implementationType) {
                    return 1;
                }
            case 6:
                break;
            case 7:
                if (other instanceof PrimType) {
                    switch (other.getSignature().charAt(0)) {
                        case 'B':
                        case 'I':
                        case 'J':
                        case 'S':
