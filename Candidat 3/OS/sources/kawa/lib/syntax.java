...
public class syntax extends ModuleBody {
    ...
    public static final Macro f8import = Macro.make(Lit36, Lit37, $instance);
    ...
    public static final Macro f9synchronized;
    ...
    static {
        ...
        f9synchronized = Macro.make(Lit25, new ModuleMethod(syntax, 3, null, FragmentTransaction.TRANSIT_FRAGMENT_OPEN), $instance);
