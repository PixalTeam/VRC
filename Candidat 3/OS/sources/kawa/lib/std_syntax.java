...
public class std_syntax extends ModuleBody {
    ...
    public static final Macro f6case = Macro.make(Lit4, Lit5, $instance);
    ...
    public static final Macro f7do = Macro.make(Lit40, Lit41, $instance);
    ...
    static {
        ...
        or = Macro.make(Lit16, new ModuleMethod(std_syntax, 2, null, FragmentTransaction.TRANSIT_FRAGMENT_OPEN), $instance);
