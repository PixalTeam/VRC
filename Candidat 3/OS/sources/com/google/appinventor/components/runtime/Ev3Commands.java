...
public class Ev3Commands extends LegoMindstormsEv3Base {
    ...
    public void KeepAlive(int minutes) {
        ...
        sendCommand(functionName, Ev3BinaryParser.encodeDirectCommand(Opcode.KEEP_ALIVE, false, 0, 0, "c", Byte.valueOf((byte) minutes)), false);
    }

    @SimpleFunction(description = "Get the battery voltage.")
    public double GetBatteryVoltage() {
        byte[] reply = sendCommand(Thread.currentThread().getStackTrace()[1].getMethodName(), Ev3BinaryParser.encodeDirectCommand(-127, true, 4, 0, "cg", Byte.valueOf(1), Byte.valueOf(0)), true);
    ...
    public double GetBatteryCurrent() {
        byte[] reply = sendCommand(Thread.currentThread().getStackTrace()[1].getMethodName(), Ev3BinaryParser.encodeDirectCommand(-127, true, 4, 0, "cg", Byte.valueOf(2), Byte.valueOf(0)), true);
        if (reply != null && reply.length == 5 && reply[0] == 2) {
            return (double) ((Float) Ev3BinaryParser.unpack("xf", reply)[0]).floatValue();
        }
        return -1.0d;
    ...
    public String GetOSVersion() {
        String functionName = Thread.currentThread().getStackTrace()[1].getMethodName();
        byte[] reply = sendCommand(functionName, Ev3BinaryParser.encodeDirectCommand(-127, true, 100, 0, "ccg", Byte.valueOf(3), Short.valueOf(100), Byte.valueOf(0)), true);
    ...
    public String GetOSBuild() {
        String functionName = Thread.currentThread().getStackTrace()[1].getMethodName();
        byte[] reply = sendCommand(functionName, Ev3BinaryParser.encodeDirectCommand(3, true, 100, 0, "ccg", Byte.valueOf(12), Short.valueOf(100), Byte.valueOf(0)), true);
        if (reply != null && reply[0] == 2) {
            return String.valueOf(Ev3BinaryParser.unpack("xS", reply)[0]);
        }
        this.form.dispatchErrorOccurredEvent(this, functionName, ErrorMessages.ERROR_EV3_INVALID_REPLY, new Object[0]);
    ...
    public String GetFirmwareVersion() {
        String functionName = Thread.currentThread().getStackTrace()[1].getMethodName();
        byte[] reply = sendCommand(functionName, Ev3BinaryParser.encodeDirectCommand(-127, true, 100, 0, "ccg", Byte.valueOf(10), Short.valueOf(100), Byte.valueOf(0)), true);
        if (reply != null && reply[0] == 2) {
            return String.valueOf(Ev3BinaryParser.unpack("xS", reply)[0]);
        }
        this.form.dispatchErrorOccurredEvent(this, functionName, ErrorMessages.ERROR_EV3_INVALID_REPLY, new Object[0]);
    ...
    public String GetFirmwareBuild() {
        String functionName = Thread.currentThread().getStackTrace()[1].getMethodName();
        byte[] reply = sendCommand(functionName, Ev3BinaryParser.encodeDirectCommand(-127, true, 100, 0, "cg", Byte.valueOf(Opcode.MEMORY_READ), Byte.valueOf(0)), true);
        if (reply != null && reply[0] == 2) {
            return String.valueOf(Ev3BinaryParser.unpack("xS", reply)[0]);
        }
        this.form.dispatchErrorOccurredEvent(this, functionName, ErrorMessages.ERROR_EV3_INVALID_REPLY, new Object[0]);
    ...
    public String GetHardwareVersion() {
        String functionName = Thread.currentThread().getStackTrace()[1].getMethodName();
        byte[] reply = sendCommand(functionName, Ev3BinaryParser.encodeDirectCommand(-127, true, 100, 0, "ccg", Byte.valueOf(9), Short.valueOf(100), Byte.valueOf(0)), true);
        if (reply != null && reply[0] == 2) {
            return String.valueOf(Ev3BinaryParser.unpack("xS", reply)[0]);
        }
        this.form.dispatchErrorOccurredEvent(this, functionName, ErrorMessages.ERROR_EV3_INVALID_REPLY, new Object[0]);
