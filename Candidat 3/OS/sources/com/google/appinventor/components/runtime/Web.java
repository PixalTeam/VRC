...
public class Web extends AndroidNonvisibleComponent implements Component {
            ...
            AsynchUtil.runAsynchronously(new Runnable() {
                public void run() {
                    try {
                        ...
                        Log.e(Web.LOG_TAG, "ERROR_UNABLE_TO_GET", e4);
    ...
    /* access modifiers changed from: private */
    public void performRequest(CapturedProperties webProps, byte[] postData, String postFile, String httpVerb) throws RequestTimeoutException, IOException {
    ...
    private static String saveResponseContent(HttpURLConnection connection, String responseFileName2, String responseType) throws IOException {
        BufferedOutputStream out;
