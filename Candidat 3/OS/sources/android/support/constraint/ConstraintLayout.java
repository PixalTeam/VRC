            ...
            if (widget2 != null) {
                ...
                if (layoutParams.helped) {
                    ...
                    try {
                        ...
                        String str = IdAsString2;
                        getTargetWidget(child3.getId()).setDebugName(str.substring(IdAsString2.indexOf("id/") + 3));
                ...
                if (layoutParams.isGuideline) {
                    ...
                    if (layoutParams.circleConstraint != -1) {
                        ...
                        if (resolvedLeftToLeft != -1) {
                            ConstraintWidget target2 = getTargetWidget(resolvedLeftToLeft);
                            if (target2 != null) {
                                widget2.immediateConnect(Type.LEFT, target2, Type.LEFT, layoutParams.leftMargin, resolveGoneLeftMargin);
                            }
                        } else if (resolvedLeftToRight != -1) {
                            ConstraintWidget target3 = getTargetWidget(resolvedLeftToRight);
                            if (target3 != null) {
                                widget2.immediateConnect(Type.LEFT, target3, Type.RIGHT, layoutParams.leftMargin, resolveGoneLeftMargin);
                            }
                        }
                        if (resolvedRightToLeft != -1) {
                            ConstraintWidget target4 = getTargetWidget(resolvedRightToLeft);
                            if (target4 != null) {
                        ...
                        if (layoutParams.baselineToBaseline != -1) {
                            ...
                            if (!(target10 == null || view2 == null || !(view2.getLayoutParams() instanceof LayoutParams))) {
                                ...
                                widget2.getAnchor(Type.BASELINE).connect(target10.getAnchor(Type.BASELINE), 0, -1, Strength.STRONG, 0, true);
    ...
    public void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (sizeDependentWidgetsCount > 0) {
            ...
            for (int i2 = 0; i2 < sizeDependentWidgetsCount; i2++) {
                ConstraintWidget widget2 = (ConstraintWidget) this.mVariableDimensionsWidgets.get(i2);
