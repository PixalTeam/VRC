...
public class AnimatedStateListDrawableCompat extends StateListDrawable {
    ...
    static class AnimatedStateListState extends StateListState {
        ...
        public boolean isTransitionReversed(int fromId, int toId) {
            return (((Long) this.mTransitions.get(generateTransitionKey(fromId, toId), Long.valueOf(-1))).longValue() & 4294967296L) != 0;
        }

        /* access modifiers changed from: 0000 */
        public boolean transitionHasReversibleFlag(int fromId, int toId) {
            return (((Long) this.mTransitions.get(generateTransitionKey(fromId, toId), Long.valueOf(-1))).longValue() & 8589934592L) != 0;
        }
