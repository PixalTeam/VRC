...
public class ContentFrameLayout extends FrameLayout {
    ...
    public void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        int widthMeasureSpec2 = MeasureSpec.makeMeasureSpec(width, Declaration.MODULE_REFERENCE);
        if (!fixedWidth && widthMode == Integer.MIN_VALUE) {
            ...
            if (!(tv == null || tv.type == 0)) {
                ...
                if (width < min) {
                    widthMeasureSpec2 = MeasureSpec.makeMeasureSpec(min, Declaration.MODULE_REFERENCE);
                    measure = true;
                }
            }
        }
