                ...
                if (child3.getVisibility() != 8) {
                    ...
                    if (childExtra > 0.0f) {
                        ...
                        if (lp3.height == 0 && heightMode == 1073741824) {
                            ...
                            child3.measure(childWidthMeasureSpec, MeasureSpec.makeMeasureSpec(share, Declaration.MODULE_REFERENCE));
                        } else {
                            int childHeight2 = child3.getMeasuredHeight() + share;
                            if (childHeight2 < 0) {
                                childHeight2 = 0;
                            }
                            child3.measure(childWidthMeasureSpec, MeasureSpec.makeMeasureSpec(childHeight2, Declaration.MODULE_REFERENCE));
                        }
                        childState = View.combineMeasuredStates(childState, child3.getMeasuredState() & -256);
                    }
            ...
            if (useLargestChild && heightMode != 1073741824) {
                for (int i4 = 0; i4 < count; i4++) {
                    ...
                    if (!(child4 == null || child4.getVisibility() == 8 || ((LayoutParams) child4.getLayoutParams()).weight <= 0.0f)) {
                        child4.measure(MeasureSpec.makeMeasureSpec(child4.getMeasuredWidth(), Declaration.MODULE_REFERENCE), MeasureSpec.makeMeasureSpec(largestChildHeight, Declaration.MODULE_REFERENCE));
                    }
                }
            }
        }
        ...
        if (skippedMeasure || (delta != 0 && totalWeight > 0.0f)) {
                ...
                if (!(child3 == null || child3.getVisibility() == 8)) {
                    ...
                    if (childExtra > 0.0f) {
                        ...
                        if (lp3.width == 0 && widthMode == 1073741824) {
                            ...
                            child3.measure(MeasureSpec.makeMeasureSpec(share, Declaration.MODULE_REFERENCE), childHeightMeasureSpec);
                        } else {
                            int childWidth2 = child3.getMeasuredWidth() + share;
                            if (childWidth2 < 0) {
                                childWidth2 = 0;
                            }
                            child3.measure(MeasureSpec.makeMeasureSpec(childWidth2, Declaration.MODULE_REFERENCE), childHeightMeasureSpec);
                        }
            ...
            if (useLargestChild && widthMode != 1073741824) {
                for (int i6 = 0; i6 < count; i6++) {
                    ...
                    if (!(child4 == null || child4.getVisibility() == 8 || ((LayoutParams) child4.getLayoutParams()).weight <= 0.0f)) {
                        child4.measure(MeasureSpec.makeMeasureSpec(largestChildWidth, Declaration.MODULE_REFERENCE), MeasureSpec.makeMeasureSpec(child4.getMeasuredHeight(), Declaration.MODULE_REFERENCE));
                    }
                }
            }
        }
