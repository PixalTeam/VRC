...
public class ViewPager extends ViewGroup {
    ...
    public void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
            ...
            if (child.getVisibility() != 8) {
                ...
                if (lp != null && lp.isDecor) {
                    ...
                    if (consumeVertical) {
                        ...
                        heightMode = Declaration.MODULE_REFERENCE;
                    }
        ...
        this.mChildWidthMeasureSpec = MeasureSpec.makeMeasureSpec(childWidthSize, Declaration.MODULE_REFERENCE);
        this.mChildHeightMeasureSpec = MeasureSpec.makeMeasureSpec(childHeightSize, Declaration.MODULE_REFERENCE);
        this.mInLayout = true;
        populate();
        ...
        for (int i2 = 0; i2 < size2; i2++) {
            ...
            if (child2.getVisibility() != 8) {
                ...
                if (lp2 == null || !lp2.isDecor) {
                    child2.measure(MeasureSpec.makeMeasureSpec((int) (((float) childWidthSize) * lp2.widthFactor), Declaration.MODULE_REFERENCE), this.mChildHeightMeasureSpec);
                }
            }
        }
    }
                ...
                if (!lp2.isDecor) {
                    ...
                    if (ii != null) {
                        ...
                        if (lp2.needsMeasure) {
                            ...
                            child2.measure(MeasureSpec.makeMeasureSpec((int) (((float) childWidth) * lp2.widthFactor), Declaration.MODULE_REFERENCE), MeasureSpec.makeMeasureSpec((height - paddingTop) - paddingBottom, Declaration.MODULE_REFERENCE));
                        }
