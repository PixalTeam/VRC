...
public class AccessibilityNodeInfoCompat {
    ...
    public static class AccessibilityActionCompat {
        ...
        static {
            ...
            AccessibilityAction accessibilityAction9 = null;
            ...
            if (VERSION.SDK_INT >= 28) {
                accessibilityAction8 = AccessibilityAction.ACTION_SHOW_TOOLTIP;
            } else {
                accessibilityAction8 = null;
            }
            ACTION_SHOW_TOOLTIP = new AccessibilityActionCompat(accessibilityAction8);
            if (VERSION.SDK_INT >= 28) {
                accessibilityAction9 = AccessibilityAction.ACTION_HIDE_TOOLTIP;
            }
            ACTION_HIDE_TOOLTIP = new AccessibilityActionCompat(accessibilityAction9);
        }
