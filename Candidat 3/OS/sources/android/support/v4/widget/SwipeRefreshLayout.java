...
public class SwipeRefreshLayout extends ViewGroup implements NestedScrollingParent, NestedScrollingChild {
    ...
    public void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (this.mTarget != null) {
            this.mTarget.measure(MeasureSpec.makeMeasureSpec((getMeasuredWidth() - getPaddingLeft()) - getPaddingRight(), Declaration.MODULE_REFERENCE), MeasureSpec.makeMeasureSpec((getMeasuredHeight() - getPaddingTop()) - getPaddingBottom(), Declaration.MODULE_REFERENCE));
            this.mCircleView.measure(MeasureSpec.makeMeasureSpec(this.mCircleDiameter, Declaration.MODULE_REFERENCE), MeasureSpec.makeMeasureSpec(this.mCircleDiameter, Declaration.MODULE_REFERENCE));
            this.mCircleViewIndex = -1;
